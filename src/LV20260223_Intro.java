public class LV20260223_Intro {
    public static void main() {
        ...
        System.out.printf("kleinesRechteck(l=%d, b=%d, u=%d, f=%d)\n",kleinesRechteck.getLaenge(), kleinesRechteck.breite, (kleinesRechteck.breite + kleinesRechteck.getFlaeche()) * 2,kleinesRechteck.getLaenge() * kleinesRechteck.breite);
        ...
        System.out.printf("kleinesRechteck(l=%d, b=%d, u=%d, f=%d)\n",kleinesRechteck.getLaenge(), kleinesRechteck.breite, kleinesRechteck.getUmfang(),kleinesRechteck.getFlaeche());
        System.out.printf("grossesRechteck(l=%d, b=%d, u=%d, f=%d)\n", grossesRechteck.getLaenge(), grossesRechteck.breite, grossesRechteck.getUmfang(), grossesRechteck.getFlaeche());
